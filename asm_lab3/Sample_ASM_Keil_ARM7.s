...
; Total number of instructions should not exceed 127 (126 excluding the last line 'halt B halt').
		...
		LDR R7, constant1 ; 0xffffffff
		LDR R8, constant2 ; 0
		LDR R9, constant3 ; 1
		
		MUL R10, R7, R7 ; FFFFFFFE00000001
		...
		MLA R10, R7, R9, R7 ; ffff ffff
		STR R10, [R2] ; Store the value of R8 into LEDS
		STR R10, [R3] ; Store the value of R8 into SEVEN_SEG
...
variable2_addr
		DCD variable2
constant1
		DCD 0xFFFFFFFF		; // const unsigned int constant1 = 0xABCD1234;
constant2
		DCD 0x00000000
constant3
		DCD 0x00000001
