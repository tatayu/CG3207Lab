...
initial begin
			...
			INSTR_MEM[7] = 32'hE287A4FD; 
			INSTR_MEM[8] = 32'hE582A000; 
			INSTR_MEM[9] = 32'hE583A000; 
			INSTR_MEM[10] = 32'hE048A829; 
			INSTR_MEM[11] = 32'hE582A000; 
			INSTR_MEM[12] = 32'hE583A000; 
			INSTR_MEM[13] = 32'hE019AB38; 
			INSTR_MEM[14] = 32'hE582A000; 
			INSTR_MEM[15] = 32'hE583A000; 
			INSTR_MEM[16] = 32'hE0B7A22B; 
			INSTR_MEM[17] = 32'hE582A000; 
			INSTR_MEM[18] = 32'hE583A000; 
			INSTR_MEM[19] = 32'hE097A2AB; 
			INSTR_MEM[20] = 32'hE582A000; 
			INSTR_MEM[21] = 32'hE583A000; 
			INSTR_MEM[22] = 32'hE08CA998; 
			INSTR_MEM[23] = 32'hE582A000; 
			INSTR_MEM[24] = 32'hE583A000; 
			INSTR_MEM[25] = 32'hE582C000; 
			INSTR_MEM[26] = 32'hE583C000; 
			INSTR_MEM[27] = 32'hE0CCAB98; 
			INSTR_MEM[28] = 32'hE582A000; 
			INSTR_MEM[29] = 32'hE583A000; 
			INSTR_MEM[30] = 32'hE582C000; 
			INSTR_MEM[31] = 32'hE583C000; 
			INSTR_MEM[32] = 32'hE5914000; 
			INSTR_MEM[33] = 32'hE5014004; 
			INSTR_MEM[34] = 32'hE5814014; 
			INSTR_MEM[35] = 32'hE59F5180; 
			INSTR_MEM[36] = 32'hE5825000; 
			INSTR_MEM[37] = 32'hE5835000; 
			INSTR_MEM[38] = 32'hE00A0594; 
			INSTR_MEM[39] = 32'hE582A000; 
			INSTR_MEM[40] = 32'hE583A000; 
			INSTR_MEM[41] = 32'hE02A5594; 
			INSTR_MEM[42] = 32'hE582A000; 
			INSTR_MEM[43] = 32'hE583A000; 
			INSTR_MEM[44] = 32'hE0844005; 
			INSTR_MEM[45] = 32'hE5824000; 
			INSTR_MEM[46] = 32'hE5834000; 
			INSTR_MEM[47] = 32'hE1844005; 
			INSTR_MEM[48] = 32'hE5824000; 
			INSTR_MEM[49] = 32'hE5834000; 
			INSTR_MEM[50] = 32'hE0856124; 
			INSTR_MEM[51] = 32'hE5826000; 
			INSTR_MEM[52] = 32'hE5836000; 
			INSTR_MEM[53] = 32'hE2555001; 
			INSTR_MEM[54] = 32'hE5825000; 
			INSTR_MEM[55] = 32'hE5835000; 
			INSTR_MEM[56] = 32'h1AFFFFFB; 
			INSTR_MEM[57] = 32'hE59F5128; 
			INSTR_MEM[58] = 32'hE5825000; 
			INSTR_MEM[59] = 32'hE5835000; 
			INSTR_MEM[60] = 32'hE3550002; 
			INSTR_MEM[61] = 32'hE5825000; 
			INSTR_MEM[62] = 32'hE5835000; 
			INSTR_MEM[63] = 32'h02555002; 
			INSTR_MEM[64] = 32'hE5825000; 
			INSTR_MEM[65] = 32'hE5835000; 
			INSTR_MEM[66] = 32'h03855002; 
			INSTR_MEM[67] = 32'hE5825000; 
			INSTR_MEM[68] = 32'hE5835000; 
			INSTR_MEM[69] = 32'hE3550002; 
			INSTR_MEM[70] = 32'h02155000; 
			INSTR_MEM[71] = 32'hE5825000; 
			INSTR_MEM[72] = 32'hE5835000; 
			INSTR_MEM[73] = 32'h0AFFFFD5; 
			INSTR_MEM[74] = 32'hEAFFFFFE; 
			for(i = 75; i < 128; i = i+1) begin 
				INSTR_MEM[i] = 32'h0; 
			end
end
...
initial begin
			...
			DATA_CONST_MEM[11] = 32'h00000010; 
